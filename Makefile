...
mock:
	...
	@mockgen -source=webook/internal/repository/article/article_author.go -package=artrepomocks -destination=webook/internal/repository/mocks/article/article_author.moc.go
	@mockgen -source=webook/internal/repository/article/article_reader.go -package=artrepomocks -destination=webook/internal/repository/mocks/article/article_reader.moc.go
